            ...
            <td colspan="2">
                ...
                $(function() {
                    ...
                    $(document).on("click", "#sel_option_delete", function() {
                        ...
                        if($el.length < 1) { // size( ) 3.0 이후부터 사라짐
                    ...
                    $(document).on("click", "#opt_value_apply", function() {
                        if($(".opt_com_chk:checked").length < 1) { // size( ) 3.0 이후부터 사라짐
                        ...
                        if($el.length > 0) { // size( ) 3.0 이후부터 사라짐
                            var $tr;
                            $el.each(function() {
                                $tr = $(this).closest("tr");
            ...
            <td colspan="2">
                ...
                $(function() {
                    ...
                    $(document).on("click", "#spl_value_apply", function() {
                        if($(".spl_com_chk:checked").length < 1) { // size( ) 3.0 이후부터 사라짐
                            alert("일괄 수정할 항목을 하나이상 체크해 주십시오.");
                            return false;
                        }
        ...
        <section class="compare_left">
            ...
            $(function() {
                ...
                $(document).on("click", "#relation .add_item", function() {
                    ...
                    var count = $("#reg_relation li").length; // size( ) 3.0 이후부터 사라짐
        ...
        <section class="compare_left">
            ...
            $(function() {
                $(document).on("click", "#event_list .add_event", function() {
                    ...
                    var count = $("#reg_event_list li").length; // size( ) 3.0 이후부터 사라짐
