...
?>
		...
		?>
		<div class="sct_icon"><?php echo item_icon($row) ?></div>
		<?php
			}
		?>
		<?php
		...
		</div><!-- END :: cart, payment, preview -->
	</div><!-- END :: mask -->
	<div class="list-payment"><!-- BIGIN :: list in basket and payment -->
		<div class="form-group"><!-- BIGIN :: form-group -->
			<div class="option"><!-- BIGIN :: option -->
				<div class='option-header'>
					<h3><?php echo $row['it_name']; ?></h3>
					<a href="#" class="list-payment-close"><i class="fa fa-close"></i></a>
				</div>
				<div class="option-body">
					...
					<div class="list_item_option">
						<input type="hidden" name="it_id[]" value="<?php echo $row['it_id']; ?>" id="it_id_<?php echo $row['it_id']; ?>" data-id="">
			...
			<div class="input-group pl-3 pr-3"><!-- BIGIN :: buttons -->
				<div class="btn-group">
					<button type="button" class="btn btn-success btn_add_cart" data-btn-type="cart">
						<i class="fa fa-shopping-cart"></i> 장바구니
					</button>
					<button type="submit" class="btn btn-primary ml-2 btn_add_buy" data-btn-type="get" onclick="itemBuySubmit('flist_<?php echo $i; ?>')">
						<i class="fa fa-credit-card"></i> 바로구매
					</button>
				</div>
			</div><!-- END :: buttons -->
		</div><!-- END :: form-group -->
	</div><!-- END :: list in basket and payment -->
	<?PHP
...
(function($) {
	...
	*/
	...
	jQuery('.option').each(function() {
		...
		it_id = jQuery(this).find('input[name^="it_id"]').val();
