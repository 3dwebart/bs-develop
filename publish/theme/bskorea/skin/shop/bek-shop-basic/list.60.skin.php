...
for ($i=1; $row=sql_fetch_array($result); $i++) {
	...
	echo "<li class=\"sct_li border-box {$sct_last}\">\n";

	echo "<div class=\"sct_img\">\n";

	if ($this->href) {
		echo "<a href=\"{$this->href}{$row['it_id']}\" data-toggle=\"tooltip\" title=\"{$row['it_name']}\">\n";
	}
	...
	*/
	...
	if ($this->href) {
		echo "<div class=\"sct_txt\"><a href=\"{$this->href}{$row['it_id']}\" data-toggle=\"tooltip\" title=\"{$row['it_name']}\">\n";
	}
