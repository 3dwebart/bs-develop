...
<script>
(function($) {
	$(document).on('mouseenter', '#sit_siblings > a', function() {
		$(this).find('span[data-img$="_img"]').addClass('on');
	});
	$(document).on('mouseleave', '#sit_siblings > a', function() {
		$(this).find('span[data-img$="_img"]').removeClass('on');
	});
})(jQuery);
</script>
				...
				<div id="sit_pvi">
					...
					<div id="sit_siblings">
						...
						if ($prev_href || $next_href) {
							...
							echo $prev_href.$prev_img.$prev_title.$prev_href2;
							echo $next_href.$next_img.$next_title.$next_href2;
						} else {
