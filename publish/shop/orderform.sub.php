...
$(function() {
    ...
    $(document).on("click", ".cp_apply", function() {
        ...
        if(!$cp_row_el.find(".cp_cancel").length) // size( ) 3.0 이후부터 사라짐
    ...
    $(document).on("click", ".od_cp_apply", function() {
        ...
        if(!$("#od_coupon_cancel").length) // size( ) 3.0 이후부터 사라짐
    ...
    $(document).on("click", ".sc_cp_apply", function() {
        ...
        if(!$("#sc_coupon_cancel").length) // size( ) 3.0 이후부터 사라짐
...
function calculate_tax()
{
    ...
    if($("input[name=od_temp_point]").length) // size( ) 3.0 이후부터 사라짐
